...
import { ArrowLeft, FileText as FileTextIcon, Crown } from 'lucide-react'; // Renamed FileText to FileTextIcon

const TermsAndConditionsPage = () => {
  const lastUpdatedDate = "3 oktober 2025";

  return (
    <div className="min-h-screen bg-light-gray py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
        ...
        <article className="bg-white p-6 sm:p-10 rounded-2xl shadow-xl border border-gray-200">
          <header className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-2 text-sm">
              Laatst bijgewerkt: {lastUpdatedDate}
            </p>
          </header>
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            ...
            <p>FactuurBaas.nl is niet aansprakelijk voor enige directe of indirecte schade voortvloeiend uit het gebruik van de Dienst, inclusief maar niet beperkt tot verlies van gegevens, gederfde winst, of schade als gevolg van onjuist gegenereerde facturen. U bent zelf verantwoordelijk voor het controleren van de gegenereerde facturen en het maken van back-ups.</p>
            
            <h2>6. Gegevensprivacy</h2>
            <p>FactuurBaas.nl verwerkt geen persoonlijke gegevens die u invoert voor het maken van facturen op een manier die ze opslaat na het genereren van de PDF. Raadpleeg ons <Link to="/privacybeleid" className="text-warm-orange hover:underline">Privacybeleid</Link> voor meer informatie over hoe wij omgaan met eventuele andere gegevens.</p>

            <h2>7. Wijzigingen van de Dienst en Voorwaarden</h2>
            <p>Wij behouden ons het recht voor om de Dienst en deze algemene voorwaarden op elk moment te wijzigen. Gewijzigde voorwaarden worden van kracht zodra ze op de website zijn gepubliceerd. Het is uw verantwoordelijkheid om de voorwaarden regelmatig te controleren.</p>
          ...
          <div className="mt-12 text-center">
             <Link to="/" className="flex items-center justify-center text-md font-heading font-bold text-deep-blue hover:text-warm-orange transition-colors group">
