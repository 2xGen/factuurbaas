...
const PremiumPage = ({ user }) => {
  ...
  return (
    <div className="min-h-screen bg-light-gray text-gray-800 flex flex-col items-center justify-center p-4">
      ...
      >
        <Link href="/dashboard" className="absolute top-6 left-6 inline-flex items-center text-deep-blue hover:text-warm-orange transition-colors font-semibold">
        ...
        <p className="mt-8 text-xs text-gray-500">
          Door te upgraden, gaat u akkoord met onze <Link href="/algemene-voorwaarden" className="underline hover:text-warm-orange">Algemene Voorwaarden</Link> en <Link href="/privacybeleid" className="underline hover:text-warm-orange">Privacybeleid</Link>.
        </p>
      </motion.div>
    </div>
  );
