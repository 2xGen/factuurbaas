...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-light-gray flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
       <Link href="/" className="absolute top-6 left-6 inline-flex items-center text-deep-blue hover:text-warm-orange transition-colors z-10 font-semibold">
      ...
      >
        <div className="text-center mb-8">
          <Link href="/" className="flex items-center justify-center text-3xl font-heading font-bold text-deep-blue mb-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="terms" className="text-sm text-gray-600">
              ...
              <Link href="/algemene-voorwaarden" target="_blank" rel="noopener noreferrer" className="underline text-deep-blue hover:text-warm-orange">
                Algemene Voorwaarden
              </Link>{" "}
              en het{" "}
              <Link href="/privacybeleid" target="_blank" rel="noopener noreferrer" className="underline text-deep-blue hover:text-warm-orange">
                Privacybeleid
              </Link>.
            </Label>
          </div>
        ...
        <p className="mt-8 text-center text-sm text-gray-600">
          ...
          <Link href="/login" className="text-deep-blue hover:text-warm-orange font-medium">
            Log hier in
          </Link>
        </p>
      </motion.div>
