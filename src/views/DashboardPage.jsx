...
const DashboardPage = () => {
  ...
  const { user, loading: appContextIsLoading } = useAuth();
  ...
  const fetchInvoices = useCallback(async () => {
    if (!user || !user.id) {
      ...
      if (!appContextIsLoading) router.replace('/login');
      return;
    }
  ...
  }, [user, setContextInvoices, toast, router, appContextIsLoading]);
  ...
  }, [user, appContextIsLoading, fetchInvoices, router]);
