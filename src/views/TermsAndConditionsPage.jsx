      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <article className="bg-white p-6 sm:p-10 rounded-2xl shadow-xl border border-gray-200">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            ...
            <p>FactuurBaas.nl verwerkt geen persoonlijke gegevens die u invoert voor het maken van facturen op een manier die ze opslaat na het genereren van de PDF. Raadpleeg ons <Link href="/privacybeleid" className="text-warm-orange hover:underline">Privacybeleid</Link> voor meer informatie over hoe wij omgaan met eventuele andere gegevens.</p>
