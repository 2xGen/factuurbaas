...
export default function VoorbeeldLandingPage({ page }) {
        ...
        <div className="container mx-auto max-w-6xl px-4 sm:px-6">
          <nav className="mb-6 text-sm text-blue-200" aria-label="Breadcrumb">
            <ol className="flex flex-wrap items-center gap-2">
              ...
              <li aria-hidden>/</li>
              <li>
                <Link href="/factuur-voorbeeld" className="hover:text-white">
                  Factuur voorbeelden
                </Link>
              </li>
              <li aria-hidden>/</li>
            ...
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                {page.templateHref && (
                  ...
                  >
                    <Link href={page.templateHref}>Bekijk template</Link>
                  </Button>
                )}
              </div>
            </div>
            ...
            <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              {page.templateHref && (
                <Button asChild variant="outline" size="lg" className="rounded-xl px-8">
                  <Link href={page.templateHref}>Bekijk bijbehorende template</Link>
                </Button>
              )}
            </div>
          </div>
