    ...
    <footer className="py-12 border-t border-gray-200 bg-slate-50 text-slate-700">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center text-sm text-slate-500 border-t border-slate-200 pt-8">
          ...
          <p>
            <a href="https://factuurbaas.nl" target="_blank" rel="noopener noreferrer" className="font-semibold text-deep-blue hover:text-warm-orange transition-colors">FactuurBaas</a> wordt aangedreven door <a href="https://2xgen.com" target="_blank" rel="noopener noreferrer" className="font-semibold text-deep-blue hover:text-warm-orange transition-colors">2xGen</a> — makers van next-gen digitale platforms, waaronder <a href="https://mygoprofile.com" target="_blank" rel="noopener noreferrer" className="font-semibold text-deep-blue hover:text-warm-orange transition-colors">MyGoProfile</a>, <a href="https://arubabuddies.com" target="_blank" rel="noopener noreferrer" className="font-semibold text-deep-blue hover:text-warm-orange transition-colors">ArubaBuddies</a> en <a href="https://toptours.ai" target="_blank" rel="noopener noreferrer" className="font-semibold text-deep-blue hover:text-warm-orange transition-colors">TopTours.ai</a>.
          </p>
        </div>
      </div>
    </footer>
